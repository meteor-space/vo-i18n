# Value Objects for i18n domains

[![Build Status](https://travis-ci.org/meteor-space/vo-i18n.svg?branch=master)](https://travis-ci.org/meteor-space/vo-i18n)
...
## Release History
You can find the release history in the [changelog](https://github.com/meteor-space/vo-i18n/blob/master/CHANGELOG.md)
